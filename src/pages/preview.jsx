...
//             })
  ...
  return (
    ...
    <Box sx={{ width: '80%' , m: 2, display: 'inline-block'}}>
      ...
      {activeStep === steps.length ? (
        ...
        <React.Fragment>
          <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2 }}>
            ...
            >
            {page1(activeStep) && (
                <div sx={{ width: '80%' , m: 2, display: 'inline-block'}}>
                    <Typography component="h1" variant="h4" align="center" >
                       Summary of participant<br/>
                    </Typography>
                          {newSummary}<br/>
            ...
            {page5(activeStep) && (
                <div>
                    {/* <Typography sx={{ fontSize: 20 }} color="text.secondary" gutterBottom> */}
                      ...
                      <h4>If YES, Select type of restrictive intervention</h4>
                      {thePage5Q1}<br/>
